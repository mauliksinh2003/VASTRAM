...
<body style="background-image: linear-gradient(-90deg, blue, aqua); text-align:center">
<div style="width:700px; margin: auto;">

<a href="wedoffers.html" class="back" >BACK TO WEDDING OFFER PAGE</a>
<h2 style="color: white; font-size: 50px ; border-style: solid;border-color: white;"  text-align="center">Renting Cart</h2> 

<div class="message_box" style="margin:10px;">
<?php echo $status; ?>
</div>     
