...
<A name="top"></A>
    ...
    <!-- MENUS -->
        ...
        <nav class="topnav" id="myTopnav" style="background-color : white">
          ...
          <ul class="menu">
            ...
            <li><a href="#">SELECT YOUR PLACE   <i class="fa fa-chevron-down" style="font-size:12px"></i></a>
                              ...
                              <ul>
                                <li><a href="contact.php">MUMBAI  <img src="https://i.pinimg.com/474x/e1/81/b7/e181b7cb6dec98c4d8efb94cfa77471c.jpg" width="25" height="25"></li>
                                <li><a href="contact.php"><a href="#"><a href="#">AGRA  <img src="https://i.pinimg.com/474x/e1/81/b7/e181b7cb6dec98c4d8efb94cfa77471c.jpg" width="25" height="25"></li>
                                <li><a href="contact.php"><a href="#">PUNE  <img src="https://i.pinimg.com/474x/e1/81/b7/e181b7cb6dec98c4d8efb94cfa77471c.jpg" width="25" height="25"></li>
                                <li><a href="contact.php">DELHI  <img src="https://i.pinimg.com/474x/e1/81/b7/e181b7cb6dec98c4d8efb94cfa77471c.jpg" width="25" height="25"></li>   
                              </ul>         
            </li>
        ...
        <!--SLIDER--> 
             ...
             <div class="slideshow" style="margin-top : 00px">
...
<div class="coltextone" style="background: transparent; margin-bottom: 20px; margin-top:-50px;height:200px;margin-left: 0px; color: 3F001B; background-color : white">
 <u><span class="blinking1" style="font-size: 40px;  margin-top:-150px;color: solid black ; "><b> ! OUR CATEGORIES ! </b></span></u><br/>
 <u><span class="blinking1" style="font-size: 20px;  margin-top:-150px;color: solid black ; "><b> ! You can check below ! </b></span></u>
...
<!--column1 and row1-->
<div class="row2" style="margin-bottom : 50px">
  <div class="column2" style="background-color:grey;width: 50%; -webkit-box-shadow: inset 0 0 50px #000000; height:410px;background: linear-gradient(to top right, #ffccff 0%, #ffffcc 100%);">
    ...
    <h1 style="color: black;text-sha\dow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;">Style means being curious and having the confidence to choose what you love.</h1>
    <h1 style="color: black;text-shaow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;">Think like a lady and act like a queen.</h1>
  <br/>
    <span class="blinking" style="color: white;margin-left: -20px;margin-top: -52%;border-radius: 50px; border-style: double;border-color: solid black ; padding: 10px;"><b>VASTRAM FAB!</b></span>
 <div>
   <!--button-->
...
<!--column2 and row2-->
<div class="row3">
  <div class="column3" style="background-color:white;width: 50%; height:410px;">
    <img src="charbaugwedding.jpg" style="width: 675px; height: 410px; ">
  </div>
  <div class="column3" style="background-color:gray;-webkit-box-shadow: inset 0 0 50px #000000;width: 50%;height:410px;background: linear-gradient(to bottom left, #66ffff 0%, #ffffcc 100%);">
...
<div>
 ...
 <div class="row4">
  ...
  <div class="column4" style="background: white; height:380px;width: 100%;text-align: center;margin-top: -55px">
   <!--audio-->
...
<a href="#" class="fa fa-youtube" style="color: white;background: #bb0000;"></a>
             ...
             <!--footer-->
                <footer style="border-color: darkgrey; border-style: solid; background-color:#111345 ; margin-top:150px; color:white; ">
                  ...
                  <p>Copyright © 2024 vastram.com | All Rights Reserved                                                           <a href="#top" class="top" >^</a></p>
